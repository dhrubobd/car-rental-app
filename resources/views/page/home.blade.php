        ...
        <div class="container pt-2">
            <div class="row align-items-center mb-5">
                <div class="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0">
                    <h2 class=" fw-bold mb-3">Rent Our Cars To Save Your Time & Money! </h2>
                    <p class="lead text-muted mb-4">Just Login and choose a car from our latest stock then you are ready to GO!</p>
                    <div class="d-flex flex-wrap">
                        <a class="btn bg-gradient-primary mb-2 mb-sm-0" href="userLogin.html">Login / Signup</a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3 p-3">
                    <div class="card px-0 text-center">
                        <img class=" card-img-top mb-3 w-100" src="./images/man.jpg" alt="">
                        <h5>Danny Bailey</h5>
